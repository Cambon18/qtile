#!/bin/bash
trizen --noconfirm -Sy xorg-server xorg-xinit lightdm lightdm-gtk-greeter qtile python-pip python-psutil picom rofi brightnessctl pulseaudio pulseaudio-bluetooth pavucontrol volctl dunst feh xscreensaver arandr brave-bin alacritty thunar gvfs gvfs-smb thunar-volman thunar-archive-plugin file-roller ristretto vlc steam lutris wine gamemode mangohud networkmanager networkmanager-openvpn network-manager-applet blueman numlockx pacman-contrib matcha-gtk-theme papirus-icon-theme papirus-folders
